...
N_MODELS = 200
N_UNITS = 30
OUTPUT_FOLDER = 'res/VPE_2d'
N_ITER = 1000
BARRIER_MULTPLIER = 5e-3
N_POINTS_QUAD = 10_000     # Number of points for the quadratures
...
def compute_x(model):
    ...
    ela = 0.5*model.willmore_energy(N_POINTS_QUAD).to(device)

    x1 = 4*torch.pi*vol/per**2
    x2 = (2*torch.pi**2)/(ela*per)
