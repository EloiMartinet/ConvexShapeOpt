...
N_MODELS = 200
N_UNITS = 60
OUTPUT_FOLDER = 'res/APW_3d'
N_ITER = 1000
BARRIER_MULTPLIER = 3e-1
N_POINTS_QUAD = 2_000_000     # Number of points for the quadratures
N_POINTS_REG = 10_000     # Number of points for the quadratures
...
def compute_x(model):
    ...
    x1_ball = (4/3*torch.pi)**(5/3)/(4/5*torch.pi)
    x2_ball = (4/3*torch.pi)/(4*torch.pi)**(3/2)
    x1 = 1/x1_ball*(vol**(5/3))/moi
    x2 = 1/x2_ball*vol/(per**(3/2))
